...
function ShowSet_0 () 
{
    ...
    myLink.setAttribute('href', 'https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/What_will_your_website_look_like');        
}

function ShowSet_1 () 
{
    myImage.setAttribute ('src','Images/example-red-square-grunge-stamp-260nw-327662909.jpg');
    myParagraph.textContent = "The above is a stock image from : ";
    myLink.textContent = "Shutterstock";
    myLink.setAttribute('href', 'https://www.shutterstock.com/search/example+stamp');        
}